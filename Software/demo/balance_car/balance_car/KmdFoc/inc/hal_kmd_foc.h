...
typedef struct
{
    ...
    bool (*const hal_kmd_get_device_id_00_63)(hal_frame_struct *pFrame, uint16_t node_id);
    bool (*const hal_kmd_get_device_id_64_95)(hal_frame_struct *pFrame, uint16_t node_id);
